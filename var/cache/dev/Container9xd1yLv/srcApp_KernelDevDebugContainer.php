...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('IKQj3vwcpq', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DW5qT5-P5l', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getRouting_LoaderService()
    {
        ...
        $c = new \Symfony\Component\HttpKernel\Config\FileLocator($b, 'E:\\FitFat-master\\src/Resources', [0 => 'E:\\FitFat-master\\src'], false);
    ...
    {
        $a = new \Symfony\Bundle\TwigBundle\Loader\NativeFilesystemLoader([], 'E:\\FitFat-master');
        $a->addPath('E:\\FitFat-master\\vendor\\symfony\\framework-bundle/Resources/views', 'Framework');
        $a->addPath('E:\\FitFat-master\\vendor\\symfony\\framework-bundle/Resources/views', '!Framework');
        $a->addPath('E:\\FitFat-master\\vendor\\symfony\\twig-bundle/Resources/views', 'Twig');
        $a->addPath('E:\\FitFat-master\\vendor\\symfony\\twig-bundle/Resources/views', '!Twig');
        $a->addPath('E:\\FitFat-master\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('E:\\FitFat-master\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('E:\\FitFat-master\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('E:\\FitFat-master\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('E:\\FitFat-master\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('E:\\FitFat-master\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('E:\\FitFat-master\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', 'DoctrineMigrations');
        $a->addPath('E:\\FitFat-master\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', '!DoctrineMigrations');
        $a->addPath('E:\\FitFat-master\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('E:\\FitFat-master\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('E:\\FitFat-master\\vendor\\api-platform\\core\\src\\Bridge\\Symfony\\Bundle/Resources/views', 'ApiPlatform');
        $a->addPath('E:\\FitFat-master\\vendor\\api-platform\\core\\src\\Bridge\\Symfony\\Bundle/Resources/views', '!ApiPlatform');
        $a->addPath('E:\\FitFat-master\\vendor\\vich\\uploader-bundle/templates', 'VichUploader');
        $a->addPath('E:\\FitFat-master\\vendor\\vich\\uploader-bundle/templates', '!VichUploader');
        $a->addPath('E:\\FitFat-master/templates');
        $a->addPath('E:\\FitFat-master\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('E:\\FitFat-master\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('E:\\FitFat-master\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($d, 'E:\\FitFat-master', 'UTF-8'));
    ...
    {
        return $this->services['web_profiler.controller.profiler'] = new \Symfony\Bundle\WebProfilerBundle\Controller\ProfilerController(($this->services['router'] ?? $this->getRouterService()), ($this->services['profiler'] ?? $this->getProfilerService()), ($this->services['twig'] ?? $this->getTwigService()), $this->parameters['data_collector.templates'], ($this->privates['web_profiler.csp.handler'] ?? $this->getWebProfiler_Csp_HandlerService()), 'E:\\FitFat-master');
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('V9PQ18zG5X', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eqbe+DJQUv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0go9M3rkx8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cHxbOJqgKo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('x2uA9NfEx2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YJm0FxO53-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TPPFsJ7xti', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Y+2lBTVCjx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $this->privates['console.command.assets_install'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\AssetsInstallCommand(($this->services['filesystem'] ?? ($this->services['filesystem'] = new \Symfony\Component\Filesystem\Filesystem())), 'E:\\FitFat-master');
    ...
    {
        $this->privates['console.command.secrets_decrypt_to_local'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsDecryptToLocalCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('E:\\FitFat-master/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('E:\\FitFat-master/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_encrypt_from_local'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsEncryptFromLocalCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('E:\\FitFat-master/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('E:\\FitFat-master/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_generate_key'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsGenerateKeysCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('E:\\FitFat-master/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('E:\\FitFat-master/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_list'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsListCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('E:\\FitFat-master/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('E:\\FitFat-master/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_remove'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsRemoveCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('E:\\FitFat-master/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('E:\\FitFat-master/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.secrets_set'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\SecretsSetCommand(($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('E:\\FitFat-master/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET')))), ($this->privates['secrets.local_vault'] ?? ($this->privates['secrets.local_vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\DotenvVault('E:\\FitFat-master/.env.dev.local'))));
    ...
    {
        $this->privates['console.command.translation_debug'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command
 7 => 'E:\\FitFat-master\\vendor\\symfony\\form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension.php', 8 => 'E:\\FitFat-master\\vendor\\symfony\\validator\\Util\\LegacyTranslatorProxy.php', 9 => 'E:\\FitFat-master\\vendor\\symfony\\framework-bundle\\CacheWarmer\\TranslationsCacheWarmer.php', 10 => 'E:\\FitFat-master\\vendor\\symfony\\translation\\DataCollector\\TranslationDataCollector.php', 11 => 'E:\\FitFat-master\\vendor\\symfony\\twig-bridge\\Extension\\TranslationExtension.php']);
    ...
    protected function getContainer_EnvVarProcessorService()
    {
        return $this->privates['container.env_var_processor'] = new \Symfony\Component\DependencyInjection\EnvVarProcessor($this, new RewindableGenerator(function () {
            yield 0 => ($this->privates['secrets.vault'] ?? ($this->privates['secrets.vault'] = new \Symfony\Bundle\FrameworkBundle\Secrets\SodiumVault('E:\\FitFat-master/config/secrets/dev', $this->getEnv('base64:default::SYMFONY_DECRYPTION_SECRET'))));
        }, 1));
    }
    ...
    {
        return $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), 'E:\\FitFat-master', function () {
    ...
    protected function getDoctrine_Migrations_DependencyFactoryService()
    {
        ...
        $a->addMigrationsDirectory('DoctrineMigrations', 'E:\\FitFat-master/migrations');
    ...
    {
        return $this->privates['doctrine.orm.default_annotation_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), [0 => 'E:\\FitFat-master\\src\\Entity', 1 => 'E:\\FitFat-master\\vendor\\vich\\uploader-bundle\\src\\Entity']);
    }
    ...
    {
        $this->privates['maker.auto_command.make_migration'] = $instance = new \Symfony\Bundle\MakerBundle\Command\MakerCommand(new \Symfony\Bundle\MakerBundle\Maker\MakeMigration('E:\\FitFat-master'), ($this->privates['maker.file_manager'] ?? $this->getMaker_FileManagerService()), ($this->privates['maker.generator'] ?? $this->getMaker_GeneratorService()));
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => [0 => 'E:\\FitFat-master\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 1 => 'E:\\FitFat-master\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 2 => 'E:\\FitFat-master\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => [0 => 'E:\\FitFat-master\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 1 => 'E:\\FitFat-master\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 2 => 'E:\\FitFat-master\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf', 3 => 'E:\\FitFat-master\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle
    ...
    {
        $this->privates['twig.command.debug'] = $instance = new \Symfony\Bridge\Twig\Command\DebugCommand(($this->services['twig'] ?? $this->getTwigService()), 'E:\\FitFat-master', $this->parameters['kernel.bundles_metadata'], 'E:\\FitFat-master/templates', ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()), 'E:\\FitFat-master\\src');
    ...
    protected function getTwig_TemplateCacheWarmerService()
    {
        return $this->privates['twig.template_cache_warmer'] = new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'twig' => 'Twig\\Environment',
        ]))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(($this->services['kernel'] ?? $this->get('kernel', 1)), 'E:\\FitFat-master\\src', ['E:\\FitFat-master\\vendor\\symfony\\twig-bridge/Resources/views/Email' => 'email', 'E:\\FitFat-master\\vendor\\symfony\\twig-bridge/Resources/views/Form' => NULL], 'E:\\FitFat-master/templates'));
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings([0 => 'E:\\FitFat-master\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        $this->privates['web_server.command.server_run'] = $instance = new \Symfony\Bundle\WebServerBundle\Command\ServerRunCommand('E:\\FitFat-master/public', 'dev', \dirname(__DIR__, 2));
    ...
    {
        $this->privates['web_server.command.server_start'] = $instance = new \Symfony\Bundle\WebServerBundle\Command\ServerStartCommand('E:\\FitFat-master/public', 'dev', \dirname(__DIR__, 2));
    ...
    {
        return [
            'kernel.root_dir' => 'E:\\FitFat-master\\src',
            'kernel.project_dir' => 'E:\\FitFat-master',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'SensioFrameworkExtraBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\sensio\\framework-extra-bundle\\src',
                    'namespace' => 'Sensio\\Bundle\\FrameworkExtraBundle',
                ],
                'TwigBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'MonologBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'DebugBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'MakerBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\symfony\\maker-bundle\\src',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'TwigExtraBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'WebServerBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\symfony\\web-server-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebServerBundle',
                ],
                'NelmioCorsBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\nelmio\\cors-bundle',
                    'namespace' => 'Nelmio\\CorsBundle',
                ],
                'ApiPlatformBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\api-platform\\core\\src\\Bridge\\Symfony\\Bundle',
                    'namespace' => 'ApiPlatform\\Core\\Bridge\\Symfony\\Bundle',
                ],
                'SymfonyCastsVerifyEmailBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\symfonycasts\\verify-email-bundle\\src',
                    'namespace' => 'SymfonyCasts\\Bundle\\VerifyEmail',
                ],
                'VichUploaderBundle' => [
                    'path' => 'E:\\FitFat-master\\vendor\\vich\\uploader-bundle',
            ...
            'translator.default_path' => 'E:\\FitFat-master/translations',
            ...
            'twig.default_path' => 'E:\\FitFat-master/templates',
            ...
            'vich_uploader.mappings' => [
                'products' => [
                    ...
                    'upload_destination' => 'E:\\FitFat-master/public/images/products',
                    'namer' => [
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHoldere37aa = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer9ece6 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiese17d1 = [
        
    ];

    public function getConnection()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getConnection', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getMetadataFactory', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getExpressionBuilder', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'beginTransaction', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getCache', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getCache();
    }

    public function transactional($func)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'transactional', array('func' => $func), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->transactional($func);
    }

    public function commit()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'commit', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->commit();
    }

    public function rollback()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'rollback', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getClassMetadata', array('className' => $className), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'createQuery', array('dql' => $dql), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'createNamedQuery', array('name' => $name), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'createQueryBuilder', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'flush', array('entity' => $entity), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'clear', array('entityName' => $entityName), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->clear($entityName);
    }

    public function close()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'close', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->close();
    }

    public function persist($entity)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'persist', array('entity' => $entity), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'remove', array('entity' => $entity), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'refresh', array('entity' => $entity), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'detach', array('entity' => $entity), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'merge', array('entity' => $entity), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getRepository', array('entityName' => $entityName), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'contains', array('entity' => $entity), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getEventManager', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getConfiguration', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'isOpen', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getUnitOfWork', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getProxyFactory', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'initializeObject', array('obj' => $obj), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'getFilters', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'isFiltersStateClean', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'hasFilters', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return $this->valueHoldere37aa->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer9ece6 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHoldere37aa) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHoldere37aa = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHoldere37aa->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, '__get', ['name' => $name], $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        if (isset(self::$publicPropertiese17d1[$name])) {
            return $this->valueHoldere37aa->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHoldere37aa;
    ...
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;
    ...
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, '__isset', array('name' => $name), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;
    ...
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, '__unset', array('name' => $name), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;
    ...
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, '__clone', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        $this->valueHoldere37aa = clone $this->valueHoldere37aa;
    }

    public function __sleep()
    {
        $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, '__sleep', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;

        return array('valueHoldere37aa');
    }
    ...
    {
        $this->initializer9ece6 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer9ece6;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer9ece6 && ($this->initializer9ece6->__invoke($valueHoldere37aa, $this, 'initializeProxy', array(), $this->initializer9ece6) || 1) && $this->valueHoldere37aa = $valueHoldere37aa;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHoldere37aa;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHoldere37aa;
    }
}
